...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/codeclimate-test-reporter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/codeclimate-test-reporter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add codeclimate-test-reporter
# for installing globally
pixi global install codeclimate-test-reporter
```
...
It is possible to list all of the versions of `codeclimate-test-reporter` available on your platform:
...
```
pixi search codeclimate-test-reporter --channel conda-forge
```
